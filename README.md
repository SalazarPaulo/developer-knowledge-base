...
```mermaid
graph TD;
    Desktop_Development-->JavaFX;
    Desktop_Development-->JavaSwing;
    Desktop_Development-->PythonTkinter;
...
graph TD;
    ...
    Software_Engineering-->Event_Driven_Programming;
    Software_Engineering-->MVC;
    Software_Engineering-->Software_Architecture;
    Software_Engineering-->Clean_Code;
    Software_Engineering-->Technical_Documentation;
```
...
graph TD;
    ...
    Professional_Skills-->English_for_Developers;
    Professional_Skills-->Technical_English;
    Professional_Skills-->Technical_Tests;
    Professional_Skills-->Coding_Challenges;
    Professional_Skills-->Behavioral_Interviews;
```
